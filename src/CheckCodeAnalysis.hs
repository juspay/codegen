...
compareASTForFuns :: (HM.HashMap String (String,[String])) -> (HM.HashMap String (String,[String])) -> CodeInput -> String  -> IO (Either String CodeOutput)
compareASTForFuns allFields dbFields codeInput genCode = do
    ...
    case emoduleAST of
        Right moduleAST -> do
            ...
            pure $ Right $ CodeOutput (prettyPrint modifiedAST) halucinatedFuns halucinatedFunScore halucinatedTypeScore mapAllRelatedFields
